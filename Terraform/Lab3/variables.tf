...
variable "thin_provisioned" {
  description = "True or false. Whether to use thin provisioning on the disk. Leave blank to use same as template"
  default     = ""
}

variable "eagerly_scrub" {
  description = " True or false. If set to true disk space is zeroed out on VM creation. Leave blank to use same as template"
  default     = ""
}

variable "keep_disk_on_remove" {
  description = "Set to 'true' to not delete a disk on removal"
  default     = "false"
}
...
variable "vm_number" {
  description = "Unique number to be added to the VM name"
  default     = "1"
}
